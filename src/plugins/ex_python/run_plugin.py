"""
This script is called by the plugin-wrapper, ex_python.js, which passes down the
...
from ex_python import ex_python

logger = logging.getLogger('ex_python')
...
plugin = ex_python(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
