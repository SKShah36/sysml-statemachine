"""
This script is called by the plugin-wrapper, PythonPlugin.js, which passes down the
...
plugin = PythonPlugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
