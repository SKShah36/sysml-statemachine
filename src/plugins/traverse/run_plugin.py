"""
This script is called by the plugin-wrapper, traverse.js, which passes down the
...
plugin = traverse(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
